...
public class RankCalculateReducer extends Reducer<Text, Text, Text, Text> {
    ...
    public void reduce(Text page, Iterable<Text> values, Context context) throws IOException, InterruptedException {
        ...
        float newRank = (1 - damping) + (damping * sumShareOtherPageRanks);
       
	// Format the value to be read by the mapper and write it to the context.
	String valToWrite = newRank + "\t" + links;
        context.write(page, new Text(valToWrite));
    }
}
